(function () {
  ...
  var I18N = {
    ...
    zh: {
      ...
      "hero.lede":
        "我的研究与工作方向是面向特定下游任务的 LLM 训练与应用，以及 Agent 系统与自进化——关注 LLM 与 Agent 如何在真实业务与垂直领域中，通过后训练、维护并接入外部知识、Harness 设计等手段提升任务完成质量。",
      "hero.location": "中国",
      "sec.interests": "研究兴趣",
      "sec.education": "教育经历",
    ...
    ja: {
      ...
      "hero.lede":
        "特定の下流タスクに向けたLLMの学習・応用、そしてエージェントシステムと自己進化を主な研究・実務の軸としています。ポストトレーニング、外部知識の維持と接続、ハーネス設計などの手段を通じて、実ビジネスや垂直領域におけるタスク完了の質を高めることに取り組んでいます。",
      "hero.location": "中国",
      "sec.interests": "研究テーマ",
      "sec.education": "学歴",
      "sec.experience": "業界経験",
    ...
    ko: {
      ...
      "hero.lede":
        "특정 다운스트림 태스크를 위한 LLM 학습과 적용, 그리고 에이전트 시스템과 자기 진화를 주된 연구·업무 방향으로 삼고 있습니다. 포스트트레이닝, 외부 지식의 유지와 연결, 하네스 설계 등의 방법을 통해 실제 비즈니스와 버티컬 도메인에서 태스크 완수 품질을 높이는 데 집중합니다.",
      "hero.location": "중국",
